...
func _FdataMachin__1000201x__receive__default(___Vdm *_TdataMachine) {
	...
	for {
		...
		case __VdmID := <-___Vdm.dmCHdataMachineIdI: // chan _TdataMachinEid
			...
			_CpfN(" 839192 02 : _TdataMachine receive dataMachinEid {%s}", __VdmID.String())
		...
		case __Vdec := <-___Vdm.dmCHdecodeDataI: // from uDeCHdecodeDataLO  // _TdecodeX
			...
			_CpfN(" 839192 04 : _TdataMachine receive _Tdecode {%s}", __Vdec.String())
		...
		case <-___Vdm.dmChSendIdleNoteInternalUSE:
			...
			_FpfNonce(" 839192 05 : _TdataMachine receive idle timeOut note . trying to send idle.")
			_CpfN(" 839192 06 : _TdataMachine receive idle timeOut note . trying to send idle.")
		...
		case <-___Vdm.dmChSwapLoginCkInfoForLock: // chan byte // a 5s timer , send swap note to main receive loop. internal use only.
			...
			_FpfNonce(" 839192 07 : reset-MachineID : _TdataMachine receive swap loginCKinfo note . ")
			_CpfN(" 839192 08 : reset-MachineID : _TdataMachine receive swap loginCKinfo note . ")
		...
		case <-___Vdm.dmChCheckTimeOutDieClient:
			...
			_CpfN(" 839192 10 : reset-MachineID : _TdataMachine receive swap loginCKinfo note . ")
