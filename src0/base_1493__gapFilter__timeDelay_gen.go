...
func (___Vgf *_TgapFilter) _FgapFilter__1200301x1__uDataSwap() {
	...
	for __Vk, __Vv := range ___Vgf.gfR.now_ { // _TgapFilter_ReceCntX
		//_FpfN(" 381917 07 ")
		//_CpfN(" 381917 08 ")
		if 1 <= __Vv.gfrCnt && 3 >= __Vv.gfrCnt {
			//_FpfN(" 381917 09 ")
			//_CpfN(" 381917 10 ")
			__Vcnt := 0
			...
			if __Vok2 {
				__Vcnt = __Vv2.gfrCnt
				//_FpfN(" 381926 01 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
				//_CpfN(" 381926 02 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
			}
			if __Vok3 {
				__Vcnt += __Vv3.gfrCnt
				//_FpfN(" 381926 03 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
				//_CpfN(" 381926 04 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
			}
			if 1 <= __Vcnt && 3 >= __Vcnt {
				//_FpfN(" 381926 05 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
				//_CpfN(" 381926 06 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
				if nil != ___Vgf.gfCHudpNodeDataReceLO {
					if 0 == len(__Vv.gfrUnb) {
						(*___Vgf.gfCHudpNodeDataReceLO) <- __Vv.gfrUnr
					} else {
					...
					if 0 == len(__Vv.gfrUnb) {
						...
						(*___Vgf.gfCHbyteLO) <- __Vv.gfrUnb
					}
				}
			} else {
				//_FpfN(" 381926 09 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
				//_CpfN(" 381926 10 %d , %d, %d", __Vcnt, __Vv2.gfrCnt, __Vv3.gfrCnt)
			}
		}
	}
