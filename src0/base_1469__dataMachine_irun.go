...
func _FdataMachin__1000101__main_init__default(___Vdm *_TdataMachine) {
	...
	___Vdm.dmCHencodeDataFnDnI = make(chan _Tencode, 50) // _TencodeX , used for Fn-Dn
	___Vdm.dmCHencodeData9999I = make(chan _Tencode, 50) // _TencodeX , used for normal data tunnel
