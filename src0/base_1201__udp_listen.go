...
type _TserviceUDP struct {
	...
	UuserLoopCall211 func(*_TserviceUDP) // UcallbackMR: _FuserCallback__dataRece__main_top__FnWaitDn,
	// _FuserCallback_u01M__dataRece_Sn _FuserCallback_u01M__dataRece_Cn

	UuserLoopCall221 func(*_TserviceUDP) // _FuserCallback_chanIn__main_top__FnWaitDn
