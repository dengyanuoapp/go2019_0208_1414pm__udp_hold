...
func (___VdmcT *_TdataMachinEconnectSt) _FdataMachin__search_avaiable__TdataMachinEconnectClient() int {
	...
	for __Vi := ___VdmcT.dcsMlastInsIdx; __Vi < _VallowClientMax; __Vi++ {
		if 0 == ___VdmcT.dcsM[__Vi].dccLastReceTime { // _TdataMachinEconnectClient
			___VdmcT.dcsM[__Vi].
				_FdataMachin__clear__TdataMachinEconnectClient(__Vi)
			return __Vi
		}
	}
...
func (___Vdmcc *_TdataMachinEconnectClient) _FdataMachin__clear__TdataMachinEconnectClient(___Vidx int) {
